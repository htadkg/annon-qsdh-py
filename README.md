# Prototype implementation of Generating q-SDH parameters in asynchronous network

NOTE: This is a research implementation and may contain security issues. Do not use this for production.


# Running and benchmarking `qsdh`
...
## Running tests and generating data points for `qsdh`
...
Then, to test the `qsdh` code locally, i.e., multiple thread in a single docker container, you need to run
```
